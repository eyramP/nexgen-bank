...
Revision ID: e63753921ec3
Revises: 
Create Date: 2025-12-09 05:00:40.101484
...
def upgrade() -> None:
    ...
    sa.Column('user_role', sa.Enum('CUSTOMER', 'ACCOUNT_EXECUTIVE', 'BRANCH_MANAGER', 'ADMIN', 'SUPER_ADMIN', 'TELLER', name='rolechoicesschema'), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('hashed_paassword', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
